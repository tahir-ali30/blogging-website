            ...
            <div className="col-lg-12">
              <Slider {...slideSettings} className="slider-activation axil-slick-arrow">
                ...
                {slidePost.slice(0, 3).map((data) => (
                  <div className="content-block" key={data._id}>
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-meta-wrapper with-button">
                        <div className="post-meta">
                          ...
                          <Image
                                src={data?.author_img || 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mPcXw8AAgMBQLfkYc4AAAAASUVORK5CYII='}
